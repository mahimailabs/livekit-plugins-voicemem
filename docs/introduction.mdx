...
<img src="/assets/two-brains.png" alt="Every turn splits two ways: durable facts, and what the person is like" />
...
they are reading your file back to you. VoiceMem stores both and injects them differently: facts
the agent may repeat, traits it may only be shaped by.
...
Derived from [VoiceMem](https://github.com/xzf-thu/VoiceMem) (Apache-2.0). The prompt templates
