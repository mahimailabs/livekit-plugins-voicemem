...
#   voicemem/leftbrain/cognitive_graph/types.py
# Changes: header only so far. Explanatory comments remain in the original
#   Chinese; translation is pending. Field names, defaults and semantics are
#   unchanged. Import updated for the slot_v2 -> slots rename.
