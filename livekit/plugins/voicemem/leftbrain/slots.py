...
#   voicemem/leftbrain/cognitive_graph/slot_v2.py
# Changes: verbatim; header only. This module is already fully English. Slot descriptions feed the embedder and the extraction prompt, so the text must not drift.
